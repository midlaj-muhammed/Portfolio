  ...
  const projects = [
    {
      id: 1,
      title: 'CloudFlow CRM',
      description: 'A comprehensive Customer Relationship Management system built with modern web technologies for managing business workflows and customer interactions.',
      category: 'web',
      technologies: ['React', 'Node.js', 'MongoDB', 'Tailwind CSS'],
      liveDemo: 'https://cloud-flow-crm.netlify.app/',
      github: 'https://github.com/midlaj-muhammed',
    ...
    },
    {
      id: 2,
      title: 'IdeaStruct',
      description: 'An innovative platform for structuring and organizing ideas using AI-powered categorization and visualization techniques.',
      category: 'nlp',
    ...
    },
    {
      id: 3,
      title: 'LeafLens',
      description: 'Computer vision application for plant disease detection using deep learning models to help farmers identify and treat crop diseases early.',
      category: 'cv',
      technologies: ['Python', 'TensorFlow', 'OpenCV', 'CNN', 'React'],
    ...
    },
    {
      id: 4,
      title: 'CortexCrawler',
      description: 'Intelligent web crawler powered by machine learning algorithms for advanced data extraction and pattern recognition.',
      category: 'dl',
      technologies: ['Python', 'Scrapy', 'Machine Learning', 'BeautifulSoup'],
    ...
    },
    {
      id: 5,
      title: 'Calor AI App',
      description: 'AI-powered nutrition and calorie tracking application using computer vision for food recognition and nutritional analysis.',
      category: 'cv',
      technologies: ['Python', 'PyTorch', 'Computer Vision', 'React Native'],
      liveDemo: '#',
      github: 'https://github.com/midlaj-muhammed',
